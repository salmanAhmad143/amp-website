...
Breadcrumbs::for('category.index', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(__('category.breadcrumb.index'), route('category.index'));
});

Breadcrumbs::for('category.create', function ($trail) {
    $trail->parent('category.index');
    $trail->push(__('category.breadcrumb.create'), route('category.create'));
});

Breadcrumbs::for('category.edit', function ($trail) {
    $trail->parent('category.index');
    $trail->push(__('category.breadcrumb.edit'), route('category.edit', '$category->id'));
});
