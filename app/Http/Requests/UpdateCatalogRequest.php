...
class UpdateCatalogRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:catalogs,name,' . $this->id,
            'slug' => 'required|string|unique:catalogs,slug,' . $this->id,
    ...
    public function messages()
    {
        return [
            ...
            'status.required' => __('catalog.form.validation.status.required'),
